  ...
  describe("considers functions as first class citizens", function() {
    ...
    it("may return arrays that contains functions and so on", function() {
      function example() {
         ...
         // return an array whose first entry is a function
         //  and THAT function's second entry is 10
         return [function () {
           return [null, 10];
         }, null];
      }
    ...
    it("can create closures with several free variables", function() {
      ...
      // I will freely admit I don't understand this test
      // Did it work in ES5 and become invalid in ES6?
      // Am I supposed to change the internal() function to take (a, b) as arguments?
    ...
    it("may return arrays that contains closures and so on", function() {
      function example() {
        // returns an array whose first entry is a function that returns [whatever, 9+x]
        return [function (x) {
          return [null, x+9];
        }, null];
      }
    ...
    it("doesnt have a private scope inside blocks", function() {
      ...
      expect(i).toEqual(5); // BUT THIS ISN'T TRUE ANYMORE?? we can use "let" to get that private scope
      expect(j).toEqual(10);
    });
  });
  ...
  describe("has multiple ways to define and create objects", function() {
    ...
    it("may create objects also with the module pattern", function() {
      function createObject(initialScore) {
        ...
        return {
          incrementScoreIn: function (x) { points += x; },
          color: 'red',
    ...
    it("can have have methods in the prototype", function() {
      ...
      // Also unsure what's happening here, or rather, what this koan is meant to demonstrate
    });
